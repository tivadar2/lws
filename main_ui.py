...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_language = QtWidgets.QTextEdit(self.frame)
        self.textEdit_language.setGeometry(QtCore.QRect(90, 30, 161, 21))
        self.textEdit_language.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.textEdit_language.setObjectName("textEdit_language")
